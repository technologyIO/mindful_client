...
const excludedDoctors = ["Ms Yamini K.V"];
  ...
  return (
    <div className="bg-white">
      ...
      <section className="py-8 px-4 bg-[#FDE4BB]">
        <DoctorsSection  location={location} expertService={"general"} excludedDoctors={excludedDoctors}/>
  ...
  <section className="py-12 bg-gray-100 border border-t-gray-300">
    <Container maxWidth="lg">
        ...
        <Container maxWidth="lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div className="space-y-8">
              {data?.whyMindfulSection?.points?.map((point, index) => (
                <div key={index}>
      ...
      {/* What to Expect Section - Light background matching the theme */}
      <section className="py-12 bg-white">
        <Container maxWidth="lg">
          <h2 className="text-2xl md:text-4xl font-bold mb-12 text-center text-orange-500">
            What to Expect
          </h2>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <ul className="space-y-6 mb-10">
              {data?.whatToExpectSection?.points?.map((point, index) => (
            ...
            {/* Next Step box with light background */}
            <div className="bg-orange-50 rounded-2xl p-8 mb-10 shadow-lg border border-orange-100">
              <p className="text-lg md:text-xl leading-relaxed text-gray-800">
                {data?.whatToExpectSection?.nextStep}
              </p>
            </div>
            ...
            <div className="flex items-center justify-center">
              <RequestAppointment
                iframeSrc={data?.zohoForm}
                header={true}
                customStyle={`flex items-center text-lg md:text-xl justify-center gap-2 w-full rounded-full bg-gradient-to-r from-orange-500 to-red-500 py-4 px-8 md:w-auto md:px-16 text-white font-bold transition-all duration-300 hover:scale-105 hover:shadow-2xl`}
                name={data?.whatToExpectSection?.cta}
                city={"delhi"}
              />
            </div>
          </div>
