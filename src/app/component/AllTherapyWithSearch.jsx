...
<p class="text-sm mb-2">Through regular conversations, you can:</p>
...
<p class="text-sm mt-4">There are many more such approaches, and our experts are trained to choose the best approach for your requirements.</p>
`
    },
    {
        _id: 3,
...
<p class="text-sm mt-4">Get in touch with us at your nearest MindfulTMS clinic to understand our pricing.</p>
`
    },
    {
        _id: 10,
...
<p class="text-sm mb-2">Getting started involves:</p>
